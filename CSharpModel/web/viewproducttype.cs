...
namespace GeneXus.Programs {
   public class viewproducttype : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public viewproducttype( IGxContext context )
      {
      ...
      public void execute( short aP0_ProductTypeCode ,
                           string aP1_TabCode )
      {
         this.AV12ProductTypeCode = aP0_ProductTypeCode;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12ProductTypeCode = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12ProductTypeCode", StringUtil.LTrimStr( (decimal)(AV12ProductTypeCode), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vPRODUCTTYPECODE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProductTypeCode), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202362113582845", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewproducttype.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ProductTypeCode,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ProductTypeCode","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewProductType");
         forbiddenHiddens.Add("ProductTypeName", StringUtil.RTrim( context.localUtil.Format( A6ProductTypeName, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewproducttype:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPRODUCTTYPECODE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12ProductTypeCode), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPRODUCTTYPECODE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProductTypeCode), "ZZZ9"), context));
      ...
      {
         return formatLink("viewproducttype.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ProductTypeCode,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ProductTypeCode","TabCode"})  ;
      }
      ...
      protected void WB0C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Product Type Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewProductType.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Product Types", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewProductType.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtProductTypeName_Internalname, StringUtil.RTrim( A6ProductTypeName), StringUtil.RTrim( context.localUtil.Format( A6ProductTypeName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductTypeName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtProductTypeName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ViewProductType.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewProductType.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProduct_title_Internalname, "Product", "", "", lblProduct_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewProductType.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void START0C2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Product Type", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0C2( )
      {
         ...
         {
            /* Using cursor H000C2 */
            pr_default.execute(0, new Object[] {AV12ProductTypeCode});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A5ProductTypeCode = H000C2_A5ProductTypeCode[0];
               A6ProductTypeName = H000C2_A6ProductTypeName[0];
      ...
      protected void STRUP0C0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12ProductTypeCode = (short)(context.localUtil.CToN( cgiGet( "vPRODUCTTYPECODE"), ".", ","));
            ...
            {
               GXUtil.WriteLogError("viewproducttype:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110C2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000C3 */
         pr_default.execute(1, new Object[] {AV12ProductTypeCode});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A5ProductTypeCode = H000C3_A5ProductTypeCode[0];
            A6ProductTypeName = H000C3_A6ProductTypeName[0];
            AssignAttri("", false, "A6ProductTypeName", A6ProductTypeName);
            AV16GXLvl6 = 1;
            Form.Caption = A6ProductTypeName;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwproducttype.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "ProductTypeGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "producttypegeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "ProductTypeGeneral";
               WebComp_Generalwc_Component = "ProductTypeGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12ProductTypeCode});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Productwc_Component), StringUtil.Lower( "ProductTypeProductWC")) != 0 )
            {
               WebComp_Productwc = getWebComponent(GetType(), "GeneXus.Programs", "producttypeproductwc", new Object[] {context} );
               WebComp_Productwc.ComponentInit();
               WebComp_Productwc.Name = "ProductTypeProductWC";
               WebComp_Productwc_Component = "ProductTypeProductWC";
            }
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               WebComp_Productwc.setjustcreated();
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0038",(string)"",(short)AV12ProductTypeCode});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12ProductTypeCode = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12ProductTypeCode", StringUtil.LTrimStr( (decimal)(AV12ProductTypeCode), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPRODUCTTYPECODE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProductTypeCode), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202362113582862", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewproducttype.js", "?202362113582863", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Product Type";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12ProductTypeCode',fld:'vPRODUCTTYPECODE',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A6ProductTypeName',fld:'PRODUCTTYPENAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000C2_A5ProductTypeCode = new short[1] ;
         H000C2_A6ProductTypeName = new string[] {""} ;
         hsh = "";
         H000C3_A5ProductTypeCode = new short[1] ;
         H000C3_A6ProductTypeName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewproducttype__default(),
            new Object[][] {
                new Object[] {
               H000C2_A5ProductTypeCode, H000C2_A6ProductTypeName
               }
               , new Object[] {
               H000C3_A5ProductTypeCode, H000C3_A6ProductTypeName
               }
            }
         );
      ...
      private short AV12ProductTypeCode ;
      private short wcpOAV12ProductTypeCode ;
      ...
      private short[] H000C2_A5ProductTypeCode ;
      private string[] H000C2_A6ProductTypeName ;
      private short[] H000C3_A5ProductTypeCode ;
      private string[] H000C3_A6ProductTypeName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewproducttype__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12ProductTypeCode",GXType.Int16,4,0)
          };
          Object[] prmH000C3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000C2", "SELECT [ProductTypeCode], [ProductTypeName] FROM [ProductType] WHERE [ProductTypeCode] = @AV12ProductTypeCode ORDER BY [ProductTypeCode] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000C3", "SELECT [ProductTypeCode], [ProductTypeName] FROM [ProductType] WHERE [ProductTypeCode] = @AV12ProductTypeCode ORDER BY [ProductTypeCode] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
