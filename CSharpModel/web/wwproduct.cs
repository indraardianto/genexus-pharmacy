...
namespace GeneXus.Programs {
   public class wwproduct : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwproduct( )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20236211422320", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB0H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWProduct.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.SendWebValue( "Product Type Name") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A1ProductCode), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A2ProductName));
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtProductName_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( A3ProductPrice, 9, 2, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A4ProductStock), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", context.convertURL( A7ProductPhoto));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtProductPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A7ProductPhoto)) ? A40000ProductPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A7ProductPhoto))), !bGXsfl_25_Refreshing);
      ...
      protected void RF0H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11ProductName = StringUtil.PadR( StringUtil.RTrim( AV11ProductName), 50, "%");
            /* Using cursor H000H2 */
            ...
            {
               A5ProductTypeCode = H000H2_A5ProductTypeCode[0];
               A40000ProductPhoto_GXI = H000H2_A40000ProductPhoto_GXI[0];
               AssignProp("", false, edtProductPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A7ProductPhoto)) ? A40000ProductPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A7ProductPhoto))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtProductPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A7ProductPhoto), true);
               A6ProductTypeName = H000H2_A6ProductTypeName[0];
               A4ProductStock = H000H2_A4ProductStock[0];
               A3ProductPrice = H000H2_A3ProductPrice[0];
               A2ProductName = H000H2_A2ProductName[0];
               A1ProductCode = H000H2_A1ProductCode[0];
               A7ProductPhoto = H000H2_A7ProductPhoto[0];
               AssignProp("", false, edtProductPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A7ProductPhoto)) ? A40000ProductPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A7ProductPhoto))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtProductPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A7ProductPhoto), true);
               A6ProductTypeName = H000H2_A6ProductTypeName[0];
               E140H2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PRODUCTCODE"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A1ProductCode), "ZZZ9"), context));
      }
      ...
      private void E140H2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("product.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A1ProductCode,4,0))}, new string[] {"Mode","ProductCode"}) ;
         edtavDelete_Link = formatLink("product.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A1ProductCode,4,0))}, new string[] {"Mode","ProductCode"}) ;
         edtProductName_Link = formatLink("viewproduct.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A1ProductCode,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"ProductCode","TabCode"}) ;
      ...
      protected void E110H2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("product.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","ProductCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20236211422353", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwproduct.js", "?20236211422353", false, true);
         }
      ...
      {
         edtProductCode_Internalname = "PRODUCTCODE_"+sGXsfl_25_idx;
         edtProductName_Internalname = "PRODUCTNAME_"+sGXsfl_25_idx;
         edtProductPrice_Internalname = "PRODUCTPRICE_"+sGXsfl_25_idx;
         edtProductStock_Internalname = "PRODUCTSTOCK_"+sGXsfl_25_idx;
      ...
      {
         edtProductCode_Internalname = "PRODUCTCODE_"+sGXsfl_25_fel_idx;
         edtProductName_Internalname = "PRODUCTNAME_"+sGXsfl_25_fel_idx;
         edtProductPrice_Internalname = "PRODUCTPRICE_"+sGXsfl_25_fel_idx;
         edtProductStock_Internalname = "PRODUCTSTOCK_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtProductCode_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A1ProductCode), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A1ProductCode), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtProductCode_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtProductPhoto_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)1,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn WWOptionalColumn",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A7ProductPhoto_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E140H2',iparms:[{av:'A1ProductCode',fld:'PRODUCTCODE',pic:'ZZZ9',hsh:true},{av:'A5ProductTypeCode',fld:'PRODUCTTYPECODE',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtProductName_Link',ctrl:'PRODUCTNAME',prop:'Link'},{av:'edtProductTypeName_Link',ctrl:'PRODUCTTYPENAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110H2',iparms:[{av:'A1ProductCode',fld:'PRODUCTCODE',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11ProductName = "";
         H000H2_A5ProductTypeCode = new short[1] ;
         H000H2_A40000ProductPhoto_GXI = new string[] {""} ;
         H000H2_A6ProductTypeName = new string[] {""} ;
         H000H2_A4ProductStock = new short[1] ;
         H000H2_A3ProductPrice = new decimal[1] ;
         H000H2_A2ProductName = new string[] {""} ;
         H000H2_A1ProductCode = new short[1] ;
         H000H2_A7ProductPhoto = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwproduct__default(),
            new Object[][] {
                new Object[] {
               H000H2_A5ProductTypeCode, H000H2_A40000ProductPhoto_GXI, H000H2_A6ProductTypeName, H000H2_A4ProductStock, H000H2_A3ProductPrice, H000H2_A2ProductName, H000H2_A1ProductCode, H000H2_A7ProductPhoto
               }
               , new Object[] {
      ...
      private short[] H000H2_A5ProductTypeCode ;
      private string[] H000H2_A40000ProductPhoto_GXI ;
      private string[] H000H2_A6ProductTypeName ;
      private short[] H000H2_A4ProductStock ;
      private decimal[] H000H2_A3ProductPrice ;
      private string[] H000H2_A2ProductName ;
      private short[] H000H2_A1ProductCode ;
      private string[] H000H2_A7ProductPhoto ;
   ...
   public class wwproduct__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A2ProductName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[ProductTypeCode], T1.[ProductPhoto_GXI], T2.[ProductTypeName], T1.[ProductStock], T1.[ProductPrice], T1.[ProductName], T1.[ProductCode], T1.[ProductPhoto]";
         sFromString = " FROM ([Product] T1 INNER JOIN [ProductType] T2 ON T2.[ProductTypeCode] = T1.[ProductTypeCode])";
         sOrderString = "";
                                             ...
                                             string A2ProductName )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([Product] T1 INNER JOIN [ProductType] T2 ON T2.[ProductTypeCode] = T1.[ProductTypeCode])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11ProductName)) )
         {
            AddWhere(sWhereString, "(T1.[ProductName] like @lV11ProductName)");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11ProductName",GXType.NChar,50,0) ,
