...
namespace GeneXus.Programs {
   public class viewproduct : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewproduct( )
      {
      ...
      public void execute( short aP0_ProductCode ,
                           string aP1_TabCode )
      {
         this.AV12ProductCode = aP0_ProductCode;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "ProductCode");
            ...
            {
               AV12ProductCode = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12ProductCode", StringUtil.LTrimStr( (decimal)(AV12ProductCode), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vPRODUCTCODE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProductCode), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20236211422284", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewproduct.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ProductCode,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ProductCode","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("ProductName", StringUtil.RTrim( context.localUtil.Format( A2ProductName, "")));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPRODUCTCODE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12ProductCode), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPRODUCTCODE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProductCode), "ZZZ9"), context));
      ...
      {
         return formatLink("viewproduct.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ProductCode,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ProductCode","TabCode"})  ;
      }
      ...
      protected void WB0G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtProductName_Internalname, StringUtil.RTrim( A2ProductName), StringUtil.RTrim( context.localUtil.Format( A2ProductName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtProductName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ViewProduct.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF0G2( )
      {
         ...
         {
            /* Using cursor H000G2 */
            pr_default.execute(0, new Object[] {AV12ProductCode});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A1ProductCode = H000G2_A1ProductCode[0];
               A2ProductName = H000G2_A2ProductName[0];
      ...
      protected void STRUP0G0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12ProductCode = (short)(context.localUtil.CToN( cgiGet( "vPRODUCTCODE"), ".", ","));
      ...
      protected void E110G2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000G3 */
         pr_default.execute(1, new Object[] {AV12ProductCode});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A1ProductCode = H000G3_A1ProductCode[0];
            A2ProductName = H000G3_A2ProductName[0];
            AssignAttri("", false, "A2ProductName", A2ProductName);
            AV16GXLvl6 = 1;
            Form.Caption = A2ProductName;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12ProductCode});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12ProductCode = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12ProductCode", StringUtil.LTrimStr( (decimal)(AV12ProductCode), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPRODUCTCODE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProductCode), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023621142232", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewproduct.js", "?2023621142232", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12ProductCode',fld:'vPRODUCTCODE',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A2ProductName',fld:'PRODUCTNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000G2_A1ProductCode = new short[1] ;
         H000G2_A2ProductName = new string[] {""} ;
         hsh = "";
         H000G3_A1ProductCode = new short[1] ;
         H000G3_A2ProductName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewproduct__default(),
            new Object[][] {
                new Object[] {
               H000G2_A1ProductCode, H000G2_A2ProductName
               }
               , new Object[] {
               H000G3_A1ProductCode, H000G3_A2ProductName
               }
            }
         );
      ...
      private short AV12ProductCode ;
      private short wcpOAV12ProductCode ;
      ...
      private short[] H000G2_A1ProductCode ;
      private string[] H000G2_A2ProductName ;
      private short[] H000G3_A1ProductCode ;
      private string[] H000G3_A2ProductName ;
   ...
   public class viewproduct__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12ProductCode",GXType.Int16,4,0)
          };
          Object[] prmH000G3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000G2", "SELECT [ProductCode], [ProductName] FROM [Product] WHERE [ProductCode] = @AV12ProductCode ORDER BY [ProductCode] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000G2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000G3", "SELECT [ProductCode], [ProductName] FROM [Product] WHERE [ProductCode] = @AV12ProductCode ORDER BY [ProductCode] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000G3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
