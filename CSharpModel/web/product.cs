   ...
   public class product : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITTRN( )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV7ProductCode = (short)(NumberUtil.Val( GetPar( "ProductCode"), "."));
               AssignAttri("", false, "AV7ProductCode", StringUtil.LTrimStr( (decimal)(AV7ProductCode), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vPRODUCTCODE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV7ProductCode), "ZZZ9"), context));
            }
         }
         if ( toggleJsOutput )
         {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtProductCode_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1ProductCode), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A1ProductCode), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductCode_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtProductCode_Enabled, 1, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Product.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtProductName_Internalname, StringUtil.RTrim( A2ProductName), StringUtil.RTrim( context.localUtil.Format( A2ProductName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtProductName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Product.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtProductPrice_Internalname, StringUtil.LTrim( StringUtil.NToC( A3ProductPrice, 9, 2, ".", "")), StringUtil.LTrim( ((edtProductPrice_Enabled!=0) ? context.localUtil.Format( A3ProductPrice, "ZZZZZ9.99") : context.localUtil.Format( A3ProductPrice, "ZZZZZ9.99"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','2');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, ',','.','2');"+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductPrice_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtProductPrice_Enabled, 0, "text", "", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "Price", "right", false, "", "HLP_Product.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtProductStock_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A4ProductStock), 4, 0, ".", "")), StringUtil.LTrim( ((edtProductStock_Enabled!=0) ? context.localUtil.Format( (decimal)(A4ProductStock), "ZZZ9") : context.localUtil.Format( (decimal)(A4ProductStock), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,49);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductStock_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtProductStock_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Product.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtProductTypeCode_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A5ProductTypeCode), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A5ProductTypeCode), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,54);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductTypeCode_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtProductTypeCode_Enabled, 1, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Product.htm");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtProductTypeName_Internalname, StringUtil.RTrim( A6ProductTypeName), StringUtil.RTrim( context.localUtil.Format( A6ProductTypeName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductTypeName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtProductTypeName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Product.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_bitmap( context, imgProductPhoto_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, imgProductPhoto_Enabled, "", "", 1, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,64);\"", "", "", "", 0, A7ProductPhoto_IsBlob, true, context.GetImageSrcSet( sImgUrl), "HLP_Product.htm");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               /* Read saved SDTs. */
               /* Read saved values. */
               Z1ProductCode = (short)(context.localUtil.CToN( cgiGet( "Z1ProductCode"), ".", ","));
               Z2ProductName = cgiGet( "Z2ProductName");
               Z3ProductPrice = context.localUtil.CToN( cgiGet( "Z3ProductPrice"), ".", ",");
               Z4ProductStock = (short)(context.localUtil.CToN( cgiGet( "Z4ProductStock"), ".", ","));
               Z5ProductTypeCode = (short)(context.localUtil.CToN( cgiGet( "Z5ProductTypeCode"), ".", ","));
               IsConfirmed = (short)(context.localUtil.CToN( cgiGet( "IsConfirmed"), ".", ","));
               IsModified = (short)(context.localUtil.CToN( cgiGet( "IsModified"), ".", ","));
               Gx_mode = cgiGet( "Mode");
               N5ProductTypeCode = (short)(context.localUtil.CToN( cgiGet( "N5ProductTypeCode"), ".", ","));
               AV7ProductCode = (short)(context.localUtil.CToN( cgiGet( "vPRODUCTCODE"), ".", ","));
               AV11Insert_ProductTypeCode = (short)(context.localUtil.CToN( cgiGet( "vINSERT_PRODUCTTYPECODE"), ".", ","));
               A40000ProductPhoto_GXI = cgiGet( "PRODUCTPHOTO_GXI");
               AV13Pgmname = cgiGet( "vPGMNAME");
               /* Read variables values. */
               if ( ( ( context.localUtil.CToN( cgiGet( edtProductCode_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtProductCode_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
               {
                  ...
                  wbErr = true;
                  A1ProductCode = 0;
                  AssignAttri("", false, "A1ProductCode", StringUtil.LTrimStr( (decimal)(A1ProductCode), 4, 0));
               }
               else
               {
            ...
            else
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") == 0 )
               {
                  Gx_mode = "DSP";
                  AssignAttri("", false, "Gx_mode", Gx_mode);
                  A1ProductCode = (short)(NumberUtil.Val( GetPar( "ProductCode"), "."));
                  AssignAttri("", false, "A1ProductCode", StringUtil.LTrimStr( (decimal)(A1ProductCode), 4, 0));
                  getEqualNoModal( ) ;
                  Gx_mode = "DSP";
                  AssignAttri("", false, "Gx_mode", Gx_mode);
      ...
      protected void E11012( )
      {
         ...
         if ( ( StringUtil.StrCmp(AV9TrnContext.gxTpr_Transactionname, AV13Pgmname) == 0 ) && ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) )
         {
            ...
            while ( AV14GXV1 <= AV9TrnContext.gxTpr_Attributes.Count )
            {
               ...
               {
                  AV11Insert_ProductTypeCode = (short)(NumberUtil.Val( AV12TrnContextAtt.gxTpr_Attributevalue, "."));
                  AssignAttri("", false, "AV11Insert_ProductTypeCode", StringUtil.LTrimStr( (decimal)(AV11Insert_ProductTypeCode), 4, 0));
               }
      ...
      protected void CheckExtendedTable011( )
      {
         ...
         {
            GX_msglist.addItem("The product name cannot be empty", 1, "PRODUCTNAME");
            AnyError = 1;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20236211422458", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z1ProductCode", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z1ProductCode), 4, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, "vPRODUCTCODE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7ProductCode), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPRODUCTCODE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV7ProductCode), "ZZZ9"), context));
      ...
      {
         return formatLink("product.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV7ProductCode,4,0))}, new string[] {"Gx_mode","ProductCode"})  ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20236211422464", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("product.js", "?20236211422465", false, true);
      ...
      {
         setEventMetadata("ENTER","{handler:'UserMainFullajax',iparms:[{postForm:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV7ProductCode',fld:'vPRODUCTCODE',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[]}");
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV9TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true},{av:'AV7ProductCode',fld:'vPRODUCTCODE',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         T00015_A1ProductCode = new short[1] ;
         ...
         T00017_A1ProductCode = new short[1] ;
         T00013_A1ProductCode = new short[1] ;
         ...
         T00018_A1ProductCode = new short[1] ;
         T00019_A1ProductCode = new short[1] ;
         T00012_A1ProductCode = new short[1] ;
         ...
         T000115_A1ProductCode = new short[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXCCtlgxBlob = "";
      ...
      private short wcpOAV7ProductCode ;
      private short Z1ProductCode ;
      ...
      private short[] T00015_A1ProductCode ;
      ...
      private short[] T00017_A1ProductCode ;
      private short[] T00013_A1ProductCode ;
      ...
      private short[] T00018_A1ProductCode ;
      private short[] T00019_A1ProductCode ;
      private short[] T00012_A1ProductCode ;
      ...
      private short[] T000115_A1ProductCode ;
   ...
   public class product__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@ProductCode",GXType.Int16,4,0)
          };
          Object[] prmT00014;
